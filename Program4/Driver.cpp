...
int main(int argc, char* argv[])
{
	...
	Mat lilImage = imread("pictures/mustache.jpeg", IMREAD_COLOR);

	Mat insetImage(bigImage);
	resize(lilImage, lilImage, Size(), 0.5, 0.5);
	...
	for (int r = 0; r < lilImage.rows; r++) {
		for (int c = 0; c < lilImage.cols; c++) {
			int tempBlue = lilImage.at<Vec3b>(r, c)[0];
			int tempGreen = lilImage.at<Vec3b>(r, c)[1];
			int tempRed = lilImage.at<Vec3b>(r, c)[2];
